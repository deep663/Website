            ...
            <div className="max-w-2xl px-6 mx-auto">
                ...
                <div className="px-4">
                    ...
                    <p className="text-gray-400 text-sm sm:text-base">
                        Binyte is a full-service social media agency that elevates your brand online. We specialize in tailored strategies, engaging content creation, and community management, ensuring every campaign aligns with your unique vision. Partner with Binyte to drive growth and build a memorable brand presence.
                    </p>
                </div>
            </div>
        </div>
