  ...
  return (
    <section className="text-white h-screen relative flex items-center justify-center bg-transparent">
      ...
      <div className="relative z-10 text-center max-w-4xl px-4">
        <h2 className="text-lg md:text-xl text-blue-300 font-semibold mb-2 md:mb-4">
          WELCOME TO BINYTE
        </h2>
        ...
        <button
          ...
          className="bg-cyan-500 text-slate-200 text-sm mt-6 py-2 px-6 md:px-8 rounded-full font-semibold hover:bg-cyan-600 transition"
        >
          LOG IN
        </button>
      </div>
